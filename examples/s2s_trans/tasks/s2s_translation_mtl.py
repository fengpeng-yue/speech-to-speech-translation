...
from examples.s2s_trans.data.s2st_dataset_mtl import S2STDatasetCreator
from fairseq.tasks import register_task
from fairseq.tasks.speech_to_text import SpeechToTextTask
from fairseq.data import Dictionary
from examples.s2s_trans.data.data_cfg import S2STDataConfig
from fairseq.speech_generator_for_s2st_mtl import (
...
@register_task('s2s_translation_mtl')
class S2ST_TranslationMTLTask(SpeechToTextTask):
    @staticmethod
    def add_args(parser):
