...
class T2STransformerEncoder(FairseqEncoder):
...
class T2STransformerDecoder(FairseqIncrementalDecoder):
...
@register_model("t2s_transformer")
class T2STransformerModel(FairseqEncoderDecoderModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        encoder = T2STransformerEncoder(args, task.src_dict, embed_speaker)
        decoder = T2STransformerDecoder(args, task.src_dict)
...
@register_model_architecture("t2s_transformer", "t2s_transformer")
