...
class S2STDataset(SpeechToTextDataset):
    ...
    def __getitem__(self, index: int) -> TextToSpeechDatasetItem:
        ...
        if self.tgt_texts is not None:
            # print(self.get_tokenized_tgt_text(index))
    ...
    def collater(self, samples: List[TextToSpeechDatasetItem]) -> Dict[str, Any]:
        ...
        # print(self.tgt_dict.symbols)
        # print(self.tgt_dict.unk_index)
        # print(self.tgt_dict.__getitem__(0))
        # print(self.tgt_dict.__getitem__(1))
        # print(self.tgt_dict.__getitem__(2))
        # print(self.tgt_dict.__getitem__(3))
        source_texts = [self.src_dict.string(samples[i].src_text) for i in order]
...
class S2STDatasetCreator(SpeechToTextDatasetCreator):
    ...
    KEY_ENERGY = "energy"
    # mandatory columns
    KEY_ID, KEY_SRC_AUDIO, KEY_TGT_AUDIO = "id", "src_audio", "tgt_audio"
    ...
    def _from_list(
        ...
        return S2STDataset(
            split_name, is_train_split, cfg, src_audio_paths, tgt_audio_paths,
            src_n_frames, tgt_n_frames,
            src_texts, tgt_texts, speakers, src_langs, tgt_langs, ids, 
            src_dict, tgt_dict,
